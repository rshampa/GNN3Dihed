...
from molecular_representation import MolecularGraphGenerator
from tqdm import tqdm_gui, tqdm
from config import MolecularGraphGeneratorConfig
...
class MolecularDataSet(Dataset):
    ...
    def initialize(self, config = None):
        ...
        self.translated_smiles = []  # To check smiles accounting for molecule skips
...
# Multi-threading starts here
    def process_smiles(self, smiles, targets):
        ...
        def process_smile(i, smile):
            ...
            if not success:
                print(f"Skipping molecule: {i} | SMILES: {smile}")
                return None
            ...
            return (atomic_features, bond_features, angle_features,
                    ...
                    angle_indices, dihedral_features, dihedral_indices, targets[i], i, smile)
        ...
        for result in results:
            ...
            self.translated_smiles.append(smile)
        ...
        self.translated_smiles = np.array(self.translated_smiles, dtype=np.str_)
# Multi-threading ends here
    ...
    def save(self, path):
        ...
        # Save translated smiles
        np.save(path + "translated_smiles.npy", self.translated_smiles)
    ...
    def load(self, path):
        ...
        # Load translated smiles
        self.translated_smiles = np.load(path + "translated_smiles.npy", allow_pickle=True)
